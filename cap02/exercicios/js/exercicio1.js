...
frm.addEventListener('submit', (e) => {
    ...
    // Arredonda o valor final para baixo, removendo os centavos
    const precoSemCentavos = Math.floor(precoComDesconto);

    // Atualiza o elemento de resposta com o resultado
    resp.innerText = `Promoção de ${medicamento}: Leve 2 por apenas R$ ${precoSemCentavos},00`;
